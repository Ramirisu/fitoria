...
#ifndef FITORIA_WEB_BASIC_MIDDLEWARE_HPP
#define FITORIA_WEB_BASIC_MIDDLEWARE_HPP
...
public:
  ...
  template <typename F>
  basic_middleware(F&& f)
    requires(!std::is_same_v<std::remove_cvref_t<F>, basic_middleware>
